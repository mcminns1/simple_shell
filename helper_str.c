 ...
 * @string1: string one, one the shorte
 * @string2: string two ,or the longer
 * @number: number of charachters to be compared, 0if infinite
 * Return: 1 if the strings are equals ,0 if the strings are differnt
 */
